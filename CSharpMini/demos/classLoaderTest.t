  ...
  equals -> { method_type = TInt; is_abstract = false; is_virtual = true;
  ...
  ]]; constructors_table : [[Program -> { arguments = []; call_constructor = None; body = StatementBlock ([]) }
  ...
  GetWeight -> { method_type = TInt; is_abstract = false; is_virtual = false;
    is_override = false; arguments = []; key = "GetWeight";
    body = Some (StatementBlock ([Return (Some (Identifier ("weight")))])) }
  ]]; constructors_table : [[PersonTIntTInt -> { arguments = [(TInt, Name ("weight")); (TInt, Name ("age"))];
  ...
  Object -> { this_key : Object; fields_table : [[]]; methods_table : [[equals -> { method_type = TInt; is_abstract = false; is_virtual = true;
    is_override = false; arguments = [(TClass ("Object"), Name ("obj"))];
    key = "equals";
    body =
    Some (StatementBlock ([If
  ...
  ]]; constructors_table : [[Object -> { arguments = []; call_constructor = None; body = StatementBlock ([]) }
  ]]; children_keys : Program Person ; is_abstract : false; is_sealed : false; parent_key : None}
  ]]
